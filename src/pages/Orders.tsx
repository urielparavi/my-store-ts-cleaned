...
function Orders() {
  ...
  return (
    <main className="fade-in min-h-screen bg-gray-50 dark:bg-zinc-900 px-3 sm:px-6 py-12 text-gray-900 dark:text-gray-100">
      <SectionTitle text="Your Orders" className="mb-8 text-3xl font-bold" />
      <div className="w-full max-w-[100rem] mx-auto bg-white dark:bg-zinc-800 rounded-2xl shadow-lg px-2 sm:px-4 lg:px-6 py-6">
        <OrdersList />
        <div className="mt-6">
          <ComplexPaginationContainer />
        </div>
